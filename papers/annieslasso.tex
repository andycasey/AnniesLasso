...
regularized model in recovering labels as a function of S/N.  The 
...
values are listed for all labels in Table \ref{tab:error-floor}, where we advocate their use as a representative error floor that should be added in quadrature with the formal errors. We stress that this is not a thorough accounting of the error budget. 
...
by our model for low S/N ratios show similar behaviour to what is seen in the high
...
regions.  The location of known strong atomic lines are indicated by vertical
