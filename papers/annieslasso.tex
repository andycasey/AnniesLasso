...
%% DWH CLARIFICATION ON HOGG-7.png image
...
%% ARC CLARIFY BOLD/NOT BOLD WITH HOGG ON HOGG-8.PNG
...
%% ARC SAY MORE ABOUT THE LIMITS HERE AS PER HOGG-9
...
%s statistically identical to the prediction/test set.
% Convincing examples of this
...
%Our precise labels have       and significantly narrowed abundance
