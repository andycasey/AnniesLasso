...
values are listed for all labels in Table \ref{tab:error-floor}, where we advocate their use as a representative error floor that should be added in quadrature with the formal errors.
