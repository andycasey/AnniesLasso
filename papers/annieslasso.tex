...
\begin{equation}
\Delta_{j} = \max{[C_{0} \cdot |y_{j} - med{y}|,C_{1} * med{y} * N_{flagged}]}
\end{equation}
...
(specifically values 9, 10, and 11) as frequently every pixel in a spectrum
would be flagged by these values, thereby producing unrealistically large 
