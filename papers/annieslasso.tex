...
We find the intrinsic spread in globular cluster abundances is $\approx$3-4 times smaller than 
previously reported.  We deliver 17 labels with associated errors for 
96,514 red giant stars, and open-source code to extend this work to other surveys.
\end{abstract}
