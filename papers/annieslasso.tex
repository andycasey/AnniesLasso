...
hyper-parameters $\Lambda = 10^3$ and $f = 2.0$.
...
At least one of our model assumptions is provably false. \apogee\ spectra have
...
% ARC: There are other fundamental issues by construction..
