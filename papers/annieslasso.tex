...
low S/N spectra in the test set.  Adopting a robust, S/N-invariant continuum 
normalization procedure is paramount.  Thus, we opted to normalize and stack the
