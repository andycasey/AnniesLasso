...
\acknowledgements
% Thanks...
The authors warmly thank Daniel Foreman-Mackey (University of Washington) for valuable discussions.
...
\begin{figure}[p]
\caption{Distribution of $\chi^2$ values for stars in the test set.\label{fig:chisq-test-set}}
\end{figure}


\begin{figure}[p]
\includegraphics[width=\textwidth]{spectrum.pdf}
\caption{A portion of (Cannon-)normalized spectra for 2M18210703-1828134,
a randomly selected star in the validation set.  The best-fit model spectra
for \aspcap\ and \TheCannon\ are shown.\label{fig:correctness}}
\end{figure}
...
\begin{figure}[p]
\caption{[X/Fe] abundance labels (y-axis) with respect to [Fe/H] to demonstrate that we recover galactic chemical evolution.\label{fig:gce}}
\end{figure}



\begin{figure}[p]
\caption{Some label projections showing the extent of the distilled sample of bonafide giants.\label{fig:test-set-hrd}}
\end{figure}
...
\begin{figure}[p]
\caption{The test scalar for the gridsearch at different $\Lambda$ and $f$.
...
% ARC: [C/N] vs [Al/Mg] (or [(Al+Si)/Mg] is even better) for clusters.
\begin{figure}[p]
\caption{[C/N] vs [Al/Mg] (or [(Al+Si)/Mg]) for bonafide members in the five globular clusters under consideration.\label{fig:gc-abundances}}
\end{figure}
...
\hline
\texttt{APOGEE\_ID} & $\alpha$ & $\delta$ & $\Teff$ & $\logg$ & [C/H] & [N/H] & [O/H] & [Na/H] & [Mg/H] & [Al/H] & [Si/H] & [S/H] & [K/H] & [Ca/H] & [Ti/H] & [V/H] & [Mn/H] & [Fe/H] & [Ni/H] \\
\hline
&&& \\
\end{tabular}
\caption{All 17-labels (and associated errors) for XX,XXX \apogee\ giant stars using the regularized model. Positions and ancillary measurements from \aspcap\ are included for convenience.  This table is online-only. A portion is shown to indicate form and content.}
